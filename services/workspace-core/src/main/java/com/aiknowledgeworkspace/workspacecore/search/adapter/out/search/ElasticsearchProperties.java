...
public class ElasticsearchProperties {
    ...
    public String getTranscriptIndexName() { return transcriptIndexName; }
    public void setTranscriptIndexName(String transcriptIndexName) { this.transcriptIndexName = transcriptIndexName; }
}
