...
@Component
public class IndexingRequestedEventCodec implements IndexingRequestEventFactory {
    ...
    @Override
    public OutboxDraft create(UUID assetId, UUID indexingJobId, String snapshotFingerprint) {
        return encode(new IndexingRequestedEventData(assetId, indexingJobId, snapshotFingerprint));
    }
